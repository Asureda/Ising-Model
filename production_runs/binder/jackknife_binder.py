...
average1,sigma1=jack_knife_2d(energy20**4,energy20**2,function3)
average2,sigma2=jack_knife_2d(energy21**4,energy21**2,function3)
average3,sigma3=jack_knife_2d(energy22**4,energy22**2,function3)
average12,sigma12=jack_knife_2d(energy_crit**4,energy_crit**2,function3)
average4,sigma4=jack_knife_2d(energy23**4,energy23**2,function3)
average5,sigma5=jack_knife_2d(energy24**4,energy24**2,function3)
average6,sigma6=jack_knife_2d(energy25**4,energy25**2,function3)
average7,sigma7=jack_knife_2d(energy26**4,energy26**2,function3)
average8,sigma8=jack_knife_2d(energy27**4,energy27**2,function3)
average9,sigma9=jack_knife_2d(energy28**4,energy28**2,function3)
average10,sigma10=jack_knife_2d(energy29**4,energy29**2,function3)
average11,sigma11=jack_knife_2d(energy30**4,energy30**2,function3)


f2 = open('binderE_cumulant.dat', "w")
...
average1,sigma1=jack_knife_2d(M20**4,M20**2,function3)
average2,sigma2=jack_knife_2d(M21**4,M21**2,function3)
average3,sigma3=jack_knife_2d(M22**4,M22**2,function3)
average12,sigma12=jack_knife_2d(M_crit**4,M_crit**2,function3)
average4,sigma4=jack_knife_2d(M23**4,M23**2,function3)
average5,sigma5=jack_knife_2d(M24**4,M24**2,function3)
average6,sigma6=jack_knife_2d(M25**4,M25**2,function3)
average7,sigma7=jack_knife_2d(M26**4,M26**2,function3)
average8,sigma8=jack_knife_2d(M27**4,M27**2,function3)
average9,sigma9=jack_knife_2d(M28**4,M28**2,function3)
average10,sigma10=jack_knife_2d(M29**4,M29**2,function3)
average11,sigma11=jack_knife_2d(M30**4,M30**2,function3)


f2 = open('binder_cumulant.dat', "w")
f2.write("2.0"+"   "+str(average1)+"   "+str(sigma1))
f2.write("\n2.1"+"   "+str(average2)+"   "+str(sigma2))
f2.write("\n2.2"+"   "+str(average3)+"   "+str(sigma3))
f2.write("\n2.269"+"   "+str(average12)+"   "+str(sigma12))
